...
private var declaredEncodables: Void = {
    ...
    declareEncodable(DkxDeletedMessageAttribute.self, f: { DkxDeletedMessageAttribute(decoder: $0) })
    declareEncodable(DkxEditHistoryAttribute.self, f: { DkxEditHistoryAttribute(decoder: $0) })
